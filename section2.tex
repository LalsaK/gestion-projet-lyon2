...
% Remplacez 'nom_image_historique.png' par le nom de votre capture d'écran de l'historique des commits
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_historique.png}
...
% Remplacez 'nom_image_collaborateurs.png' par votre capture d'écran des paramètres GitHub
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_collaborateurs.png}
...
% Remplacez 'nom_image_pullrequest.png' par votre capture d'écran d'une PR et des commentaires
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_pullrequest.png}
    \caption{Exemple d'une Pull Request avec relecture et validation croisée.}
\end{figure}
...
% Remplacez 'nom_image_kanban.png' par votre capture d'écran du tableau GitHub Projects
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_kanban.png}
...
% Remplacez 'nom_image_actions.png' par votre capture d'écran de l'onglet Actions
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_actions.png}
...
% Remplacez 'nom_image_submodule.png' par la capture du terminal montrant l'ajout du submodule
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_submodule.png}
...
Enfin, pour finaliser notre projet, nous avons déployé une page web de présentation via \textit{GitHub Pages}[cite: 29, 31]. 
L'URL de notre site est la suivante : \textbf{[À COMPLÉTER AVEC L'URL DU SITE]}[cite: 31].
De plus, la version finale de ce document a été figée dans l'historique à l'aide d'un tag Git (version \texttt{v1.0})[cite: 24].

% Remplacez 'nom_image_tag_web.png' par la capture du tag ou du site web
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{nom_image_tag_web.png}
    \caption{Création du tag de version finale et aperçu du site web.}
\end{figure}